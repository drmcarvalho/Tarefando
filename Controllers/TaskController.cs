...
namespace Tarefando.Api.Controllers
{
    ...
    {
        [HttpGet("criteria")]
        public IActionResult ListTasks([FromServices] TasksOnlyRead listTasks, [FromQuery] string? q = null, [FromQuery] bool grouped = false, [FromQuery] bool? isCanceled = null, [FromQuery] bool? isCompleted = null, [FromQuery] ETaskType? taskType = null, [FromQuery] bool noCache = false)
        {
            if (grouped)
            {
        ...
        public IActionResult CountPendingTasks([FromServices] TasksOnlyRead listTasks, [FromQuery] bool noCache = false)
        {
        ...
        [HttpGet("{taskId}")]
        public IActionResult GetTaskById([FromServices] TasksOnlyRead listTasks, int taskId, [FromQuery] bool noCache = false)
        {
